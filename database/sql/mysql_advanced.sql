...
-- Payment trend report procedure
DROP PROCEDURE IF EXISTS sp_payment_trend_report;
...
-- Cashier transaction summary procedure
DROP PROCEDURE IF EXISTS sp_cashier_transaction_summary;
...
-- Auto balance recalculation trigger (on payment confirm)
DROP TRIGGER IF EXISTS trg_payments_after_confirm;
