...
(static function (): void {
    ...
    // Also set PHP session name directly so it can't be contaminated
    // by a prior vhost request on the same worker thread.
    if (! empty($vals['SESSION_COOKIE'])) {
        session_name($vals['SESSION_COOKIE']);
    }
})();
